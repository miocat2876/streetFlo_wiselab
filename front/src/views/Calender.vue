<template>
  <div class="contents_box">
    <div class="content_1200 calendar claer">
      <div class="left">
        <div class="top">
          ...
          <h3>
            <a
              class="mon_before"
              @click="calenderPrev"></a>{{ computedMonthNames }}, {{ year
              }}<a
              class="mon_after"
              @click="calenderNext"></a>
          </h3>
          <a
            class="add_bt"
            v-if="state == 'mypage'"
            :class="[addBt ? 'on' : '']"
            @click="addBt = !addBt">Add Class</a>
          <ul
            class="add_class"
      ...
      <div
        class="right"
        :style="[state != 'mypage' ? 'min-height: auto' : '']">
        <table>
          <tr
