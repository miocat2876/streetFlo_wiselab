<template>
  <div>
    <header class="w-100">
      <div class="content_1200 menu">
        ...
        <a href="javascript:void(0)" class="menu_toggle">
          <img src="@/images/menu.svg" alt="menubar"
        /></a>
        <h1 class="logo">
          <a href="/">[Street-Flo]</a>
        </h1>
      </div>
      <nav id="nav" v-if="done" :class="{show: isShowNav}">
        <div class="nav">
          <div class="nav_title">
            <a href="javascript:void(0)">Menu</a>
            <a href="javascript:void(0)" class="nav_toggle"
              ><img src="@/images/menu-black.svg" alt="menubar"
            /></a>
          </div>
          <ul class="nav_menu">
          ...
          <div class="nav_sns">
            <a href="javascript:void(0)"><img src="@/images/instar.png" alt="insta" /></a>
            <a href="javascript:void(0)"><img src="@/images/mail.png" alt="mail" /></a>
          </div>
        </div>
      </nav>
    </header>

    <div v-if="false" id="loginPopupLayer">
      <div class="popup_login">
        ...
        <div class="content_box">
          <ul class="sns">
            ...
            <li>
              <img src="@/images/google.svg" class="google" />
    ...
    <div v-if="false" id="signUpPopupLayer1">
      <div class="popup_login">
        <div class="title_bar">
          <h2>SNS Sign-Up</h2>
          <a class="close"></a>
    ...
    <div v-if="false" id="signUpPopupLayer2">
      <div class="popup_login">
        <div class="title_bar">
          <h2>SNS Sign-Up</h2>
          <a class="close"></a>
