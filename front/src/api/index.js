...
const profileTeacherAdd = (data) => {
  return axios.post(`${commonUrl}/profileTeacherAdd`, data);
};


export { scheduleFind, scheduleAdd, scheduleSubscribeAdd, profileStudentAdd, profileTeacherAdd};